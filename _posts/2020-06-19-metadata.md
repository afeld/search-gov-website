...
<br>**Detail:** The language the main page text is written in. If the `lang` attribute is missing, we will try to determine the language of the page. We encourage you to include the `lang` attribute at all times, though, as misidentification can occur in a couple of scenarios: 
...
<br>
<br>**Used in:** Filtering content to match the language of the search site. For example, we'll return English content for sites set to English, and Spanish content for sites set to Spanish.<br>
<br>
